        ...
        <>
            <nav className="navbar position-fixed w-100 d-flex align-items-center justify-content-between" style={{ backgroundColor: '#000', padding: '10px 20px', zIndex: '1000', boxShadow: '0 2px 5px rgba(0, 0, 0, 0.2)' }}>
                ...
                <div className="d-flex align-items-center ms-auto">
                    ...
                    <a href="/user_exercise" className="nav-link me-4" style={{ color: '#fff', textDecoration: 'none' }}>
                        <Dumbbell size={20} />
                    </a>
                    <a href="/user_meal" className="nav-link me-4" style={{ color: '#fff', textDecoration: 'none' }}>
                        <Utensils size={20} />
                    </a>
                    <a href="/leaderboards" className="nav-link me-4" style={{ color: '#fff', textDecoration: 'none' }}>
                        <Trophy size={20} />
                    </a>
